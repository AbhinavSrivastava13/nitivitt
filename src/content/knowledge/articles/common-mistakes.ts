...
export const commonMistakes: Article = {
  ...
  author: "NitiVitt",
  summary:
    "A field guide to the most common wealth-destroying habits we see in Indian households, from ULIPs and gold obsession to skipping term insurance and chasing top-performing funds.",
  sections: [
    {
      heading: "Skipping term and health insurance",
      body:
        "The single most expensive mistake in Indian personal finance is being under-insured. A ₹5 lakh hospitalisation with no cover can wipe out five years of SIP progress in a week. A working parent's early death without term insurance can force spouse and children into decisions they never should have had to make.\n\nBoth policies cost less than most people's monthly restaurant bill. Skipping them to 'save' money is the classic false economy.",
    },
    {
    ...
    },
    {
      ...
      body:
        "The mutual fund magazine's 'top 5 funds of the year' is a trap. Winners rotate. The 5-star fund of 2023 often lags in 2025. By the time you buy it, its outperformance is mostly behind it.\n\nUse a Nifty 50 or Nifty 500 index fund as the core of your portfolio. Boring, low-cost, and it beats most active funds over 15+ years.",
    },
    {
    ...
    },
    {
      ...
      body:
        "The whole point of a SIP is buying more when prices fall. Stopping SIPs during a crash converts the strategy into 'buy high, sell low', which is exactly wrong.\n\nAutomate the SIP, delete the app for a month, and let it work.",
    },
    {
    ...
    },
    {
      ...
      body:
        "Buying a product only for its 80C benefit typically leaves you with a bad product AND poor after-tax returns. Buy for the actual job first (protection, growth, liquidity), then choose the tax-efficient version.",
    },
  ],
  keyTakeaways: [
    "The costliest mistakes are usually about protection and behaviour, not fund selection.",
    "Never mix insurance and investment.",
    "Cap EMI at 30% of income; keep 6 months of essentials in an emergency fund.",
    "Index funds and consistent SIPs beat clever picks over 15+ years.",
  ],
  relatedSlugs: ["insurance-planning", "emergency-fund", "sip-for-beginners"],
};
